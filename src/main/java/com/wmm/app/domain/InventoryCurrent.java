...
@Table(
    ...
    uniqueConstraints = { @UniqueConstraint(name = "ux_inventorycurrent_st_mat", columnNames = { "storage_type", "material" }) }
)
public class InventoryCurrent implements Serializable {
