...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_MECHANICTILE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_MECHANICTILE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_MECHANICTILE actions', async () => {
      const arg = { id: 20005 };
    ...
    it('dispatches UPDATE_MECHANICTILE actions', async () => {
      const arg = { id: 20005 };
    ...
    it('dispatches PARTIAL_UPDATE_MECHANICTILE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_MECHANICTILE actions', async () => {
      const arg = 42666;
