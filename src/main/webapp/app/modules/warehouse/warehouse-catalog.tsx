    ...
    <div style={{ position: 'relative', minHeight: '100vh' }}>
      ...
      <div className="container mt-4 mechanic-catalog" style={{ position: 'relative', zIndex: 1 }}>
        <Row className="mb-2 align-items-center">
          <Col>
            <h4 style={{ fontWeight: 700, color: '#2f3542' }}>Витрина старшего кладовщика</h4>
          </Col>
          ...
          <Col className="text-end d-flex align-items-center justify-content-end gap-3">
            ...
            <Button
              style={{
                background: isEditing ? 'rgba(108, 117, 125, 0.9)' : 'linear-gradient(135deg, #4dabf7 0%, #228be6 100%)',
                border: 'none',
